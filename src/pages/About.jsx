          ...
          <div className="">
            ...
            <div className="text text-white font-poppins text-[1rem] leading-[2] rounded-2xl p-[1em] font-light bg-black">
              ...
              <div className="body pt-4 border-t">
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Blanditiis ratione velit deserunt maxime tempora ad quod hic
                reprehenderit, dolore nam debitis consectetur quo harum corrupti
                neque facilis, deleniti numquam autem unde, explicabo quidem
                distinctio animi vel. Maiores labore maxime vel ipsum cupiditate
                officiis, et hic facilis assumenda qui voluptate nobis quidem at
                mollitia explicabo praesentium debitis, quam asperiores pariatur
                repudiandae illo ea! Quos saepe, dolores exercitationem modi ad
                maiores enim iste, corrupti natus veritatis maxime inventore
                libero sequi explicabo cumque itaque et quas? Eum, commodi ipsam
                recusandae beatae deleniti dolore sequi voluptate maiores
                sapiente, corporis sint, provident expedita saepe. Nobis?
              </div>
            </div>
          </div>
          <div>
